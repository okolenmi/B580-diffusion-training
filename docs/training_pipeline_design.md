...
what's genuinely still open: `NF4WeightStore`'s real-run quality check
(the forward path itself is now implemented, see 3.3), and two pieces of
*validation* work that
